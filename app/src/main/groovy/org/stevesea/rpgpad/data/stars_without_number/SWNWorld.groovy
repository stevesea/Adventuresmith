...
with lethal reprisals.''',
                    ...
                    friends: 'Crusading offworld investigator, Conspiracy-theorist local, Idealistic government reformer'.tokenize(','),
                    complications: 'The government has a good reason to keep the truth concealed, The government ruthlessly oppresses the natives, The government is actually composed of offworlders'.tokenize(','),
                    things: 'Elaborate spy devices, Memory erasure tech, Possessions of the last offworlder who decided to spread the truth'.tokenize(','),
                    places: 'Desert airfield, Deep subterranean bunker, Hidden mountain valley'.tokenize(',')
            ),
...
environments, techniques of surveillance and control can grow baroque and extreme.''',
                    enemies: 'Native dreading outsider contamination, Saboteur from another bubble city, Local official hostile to outsider ignorance of laws'.tokenize(','),
                    ...
                    complications: 'Bubble rupture, Failing atmosphere reprocessor, Native revolt against officials, All-seeing surveillance cameras'.tokenize(','),
...
uprising against tyranny, or it might just be the result of schemers who plan to be the new masters once the revolution is complete.''',
                    enemies: 'Faction commissar, Angry native, Conspiracy theorist who blames offworlders for the war, Deserter looking out for himself, Guerilla bandits'.tokenize(','),
                    friends: 'Faction loyalist seeking aid, Native caught in the crossfire, Offworlder seeking passage off the planet'.tokenize(','),
...
may exist, but all real decisions are made by the local viceroy.''',
                    enemies: 'Suspicious security personnel, Offworlder-hating natives, Local crime boss preying on rich offworlders'.tokenize(','),
                    friends: 'Native resistance leader, Colonial official seeking help, Native caught between the two sides'.tokenize(','),
                    complications: 'Natives won’t talk to offworlders, Colonial repression, Misunderstood local customs'.tokenize(','),
...
host secret cults that perpetuate these improvements regardless of the cost, and a few planets have been taken over entirely by the cults.''',
                    ...
                    complications: 'The altered cultists look human, The locals are terrified of any unusual physical appearance, The genetic modificationsand drawbacks- are contagious with long exposure'.tokenize(','),
                    ...
                    places: 'Eugenic breeding pit, Isolated settlement of altered humans, Public place infiltrated by cult sympathizers'.tokenize(',')
            ),
...
retain a functioning Exchange Consulate where banking services and arbitration can be arranged.''',
                    enemies: 'Corrupt Exchange official, Indebted native who thinks the players are Exchange agents, Exchange official dunning the players for debts incurred'.tokenize(','),
                    friends: 'Consul in need of offworld help, Local banker seeking to hurt his competition, Exchange diplomat'.tokenize(','),
...
danger in their midst.''',
                    enemies: 'Mad scientist, Maltech buyer from offworld, Security enforcer'.tokenize(','),
                    friends: 'Victim of maltech, Perimeter agent, Investigative reporter, Conventional arms merchant'.tokenize(','),
                    complications: 'The maltech is being fabricated by an unbraked AI, The government depends on revenue from maltech sales to offworlders, Citizens insist that it’s not really maltech'.tokenize(','),
...
reason, they are willing to negotiate and deal honestly with strangers, and appear to lack the worst impulses of their fellows.''',
                    enemies: 'Driven hater of all their kind, Internal malcontent bent on creating conflict, Secret master who seeks to lure trust'.tokenize(','),
                    friends: 'Well-meaning bug-eyed monster, Principled eugenics cultist, Suspicious investigator'.tokenize(','),
                    complications: 'The group actually is as harmless and benevolent as they seem, The group offers a vital service at the cost of moral compromise, The group still feels bonds of affiliation with their hostile brethren'.tokenize(','),
...
requirements.''',
                    ...
                    places: 'Atop a bizarre geological formation, Tourist resort catering to offworlders'.tokenize(',')
            ),
...
world’s sun never pierces its thick banks of clouds.''',
                    enemies: 'Criminal using the weather as a cover, Weather cultists convinced the offworlders are responsible for some disaster, Native predators dependent on the weather'.tokenize(','),
...
sector have come to strike it rich.''',
                    ...
                    things: 'Cases of the refined element, Pretech mining equipment, A dead prospector’s claim deed'.tokenize(','),
...
their neighbor and any sympathizers with loathing.''',
                    enemies: 'Native convinced that the offworlders are agents of Them, Cynical politician in need of scapegoats'.tokenize(','),
...
The locals may enjoy a correspondingly higher lifestyle, or the products might be devoted towards vast projects for the aggrandizement of the rulers.''',
                    ...
                    complications: 'The factories are toxic, The resources extractable at their tech level are running out, The masses require the factory output for survival, The industries’ major output is being obsoleted by offworld tech'.tokenize(','),
...
offworld. Major mining efforts are necessary to extract the minerals, and many natives work in the industry.''',
                    ...
                    things: 'The mother lode, Smuggled case of refined mineral, Faked crystalline mineral samples'.tokenize(','),
...
swarms, stellar radiation, hostile aliens in the asteroid belt, or periodic comet clouds''',
                    ...
                    complications: 'The natives believe the danger is divine chastisement, The natives blame outworlders for the danger, The native elite profit from the danger in some way'.tokenize(','),
...
suited for certain work.''',
                    enemies: 'Monopolist, Offworlder seeking prohibition of the specialty, Native who views the specialty as sacred'.tokenize(','),
                    friends: 'Spy searching for the source, Artisan seeking protection, Exporter with problems'.tokenize(','),
                    complications: 'The specialty is repugnant in nature, The crafters refuse to sell to offworlders, The specialty is made in a remote, dangerous place, The crafters don’t want to make the specialty any more'.tokenize(','),
...
they may simply consider offworlders too dangerous or repugnant to be allowed among the population.''',
                    enemies: 'Customs official, Xenophobic natives, Existing merchant who doesn’t like competition'.tokenize(','),
                    friends: 'Aspiring tourist, Anthropological researcher, Offworld thief, Religious missionary'.tokenize(','),
                    complications: 'The locals carry a disease harmless to them and lethal to outsiders, The locals hide dark purposes from offworlders, The locals have something desperately needed but won’t bring it into the treaty port'.tokenize(','),
...
Planets with inedible alien life rely on gengineered Terran sea crops.''',
                    ...
                    friends: 'Daredevil fisherman, Sea hermit, Sapient native life'.tokenize(','),
                    complications: 'The liquid flux confuses grav engines too badly for them to function on this world, Sea is corrosive or toxic, The seas are wracked by regular storms'.tokenize(','),
                    things: 'Buried pirate treasure, Location of enormous schools of fish, Pretech water purification equipment'.tokenize(','),
...
regressed into a topic for legends. The players might be on the first offworld ship to land since the First Wave of colonization a thousand years ago.''',
                    ...
                    complications: 'Automatic defenses fire on ships that try to take off , The natives want to stay out of contact, The natives are highly vulnerable to offworld diseases, The native language is completely unlike any known to the group'.tokenize(','),
...
entrance of those not suitably pious or devout.''',
                    ...
                    friends: 'Protector of the holy site, Naive offworlder pilgrim, Outsider wanting to learn the sanctum’s inner secrets'.tokenize(','),
                    ...
                    things: 'Ancient relic guarded at the site, Proof of the site’s inauthenticity, Precious offering from a pilgrim'.tokenize(','),
...
or may not understand the operation or replication of these devices, but they seek and guard them jealously.''',
                    ...
                    friends: 'Offworld scientist, Robbed collector, Cult heretic'.tokenize(','),
...
hostile relationship with the aliens, but a certain intrinsic tension is likely. Small human colonies might have been enslaved or otherwise subjugated.''',
                    enemies: 'Hostile alien chief, Human firebrand, Dangerous local predator, Alien religious zealot'.tokenize(','),
                    ...
                    places: 'Alien village, Fortified human settlement, Massacre site'.tokenize(',')
            ),
...
an unreasoning terror of those “mutant freaks”. Psychics demonstrate their powers at risk of their lives.''',
                    enemies: 'Mental purity investigator, Suspicious zealot, Witch-finder'.tokenize(','),
                    friends: 'Hidden psychic, Offworlder psychic trapped here, Offworld educator'.tokenize(','),
...
worlds are likely either directly subservient to it or tack carefully to avoid its anger. It may even be the capital of a small stellar empire.''',
                    enemies: 'Ambitious general, Colonial official, Contemptuous noble'.tokenize(','),
                    friends: 'Diplomat, Offworld ambassador, Foreign spy'.tokenize(','),
                    complications: 'The hegemon’s influence is all that’s keeping a murderous war from breaking out on nearby worlds, The hegemon is decaying and losing its control, The government is riddled with spies, The hegemon is genuinely benign'.tokenize(','),
                    things: 'Diplomatic carte blanche, Deed to an offworld estate, Foreign aid grant'.tokenize(','),
...
severely here. The locals may provide lists of these laws to offworlders, but few non-natives can hope to master all the important intricacies.''',
                    enemies: 'Law enforcement officer, Outraged native, Native lawyer specializing in peeling offworlders, Paid snitch'.tokenize(','),
                    friends: 'Frustrated offworlder, Repressed native, Reforming crusader'.tokenize(','),
                    complications: 'The laws change regularly in patterns only natives understand, The laws forbid some action vital to the party, The laws forbid the simple existence of some party members, The laws are secret to offworlders'.tokenize(','),
...
feared and shunned.''',
                    enemies: 'Rigid reactionary, Wary ruler, Regime ideologue, offended potentate'.tokenize(','),
...
alien relic that requires regular upkeep in order to prevent planetary catastrophe, the menace is a constant shadow on the populace.''',
                    enemies: 'Hostile outsider bent on freeing the menace, Misguided fool who thinks he can use it, Reckless researcher who thinks he can fix it'.tokenize(','),
...
manipulated by hidden masters.''',
                    enemies: 'An agent of the cabal, Government official who wants no questions asked, Willfully blinded local'.tokenize(','),
                    friends: 'Paranoid conspiracy theorist, Machiavellian gamesman within the cabal, Interstellar investigator'.tokenize(','),
                    complications: 'The secret masters have a benign reason for wanting secrecy, The cabal fights openly amongst itself, The cabal is recruiting new members'.tokenize(','),
                    things: 'A dossier of secrets on a government official, A briefcase of unmarked credit notes, The identity of a cabal member'.tokenize(','),
                    places: 'Smoke-filled room, Shadowy alleyway, Secret underground bunker'.tokenize(',')
            ),
...
likely to be both illegal and socially unacceptable.''',
                    ...
                    friends: 'Heretic, Offworld theologian, Atheistic merchant, Desperate commoner'.tokenize(','),
...
that is left now are ruins, bones, and silence.''',
                    ...
                    complications: 'The ruins are full of booby-traps left by the final inhabitants, The world’s atmosphere quickly degrades anything in an opened building, A handful of desperate natives survived the Silence, The structures are unstable and collapsing'.tokenize(','),
...
and reason with a speed impossible for humans, and can demonstrate a truly distressing subtlety at times.''',
                    enemies: 'AI Cultist, Maltech researcher, Government official dependent on the AI'.tokenize(','),
                    friends: 'Perimeter agent, AI researcher, Braked AI'.tokenize(','),
                    complications: 'The AI’s presence is unknown to the locals, The locals depend on the AI for some vital service, The AI appears to be harmless, The AI has fixated on the group’s ship’s computer, The AI wants transport offworld'.tokenize(','),
                    things: 'The room-sized AI core itself, Maltech research files, Perfectly tabulated blackmail on government officials, Pretech computer circuitry'.tokenize(','),
...
neighbors. Most like to wrap themselves in the mantle of ideology, religious fervor, or an ostensibly legitimate right to rule.''',
                    ...
                    friends: 'Vengeful commoner, Government military officer, Humanitarian aid official, Village priest'.tokenize(','),
                    complications: 'The warlords are willing to cooperate to fight mutual threats, The warlords favor specific religions or races over others, The warlords are using substantially more sophisticated tech than others, Some of the warlords are better rulers than the government'.tokenize(','),
                    things: 'Weapons cache, Buried plunder, A warlord’s personal battle harness, Captured merchant shipping'.tokenize(','),
                    places: 'Gory battlefield, Burnt-out village, Barbaric warlord palace, Squalid refugee camp'.tokenize(',')
            ),
...
locals with superior tech or impressive cultural qualities. The aliens might even be the ruling class on the planet.''',
                    enemies: 'Offworld xenophobe, Suspicious alien leader, Xenocultural imperialist'.tokenize(','),
                    friends: 'Benevolent alien, Native malcontent, Gone-native offworlder'.tokenize(','),
                    ...
                    places: 'Alien district, Alien-influenced human home, Cultural festival celebrating alien artist'.tokenize(',')
            ),
